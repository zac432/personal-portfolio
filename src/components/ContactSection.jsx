...
// footer is left when i send a message and its sent i need to clear the form and also make it realistic liek receive messages etc
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a
                                    href="tel:+14376628581 className="
                                    className="text-muted-foreground hover:text-primary transitions-colors"
                                >+1 (437) 662 8581
                                </a>
                            </div>
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space x-4 justify-center">
                            <a href="https://www.linkedin.com/in/zakaria-a-arwadi/" target="_blank" rel="noopener noreferrer">
                            <Linkedin />
                            </a>
                            <a>
                                <Twitter />
